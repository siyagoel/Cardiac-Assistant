#Calculation of important metrics using Linear Regression algorithm

#Import all the libraries needed to construct the Linear Regression algorithm
%reset
import numpy as np
import pandas as pd
import sklearn
...
for i in range(n_iterations):
    ...
    #Use Linear Regression model to fit the training datasets
